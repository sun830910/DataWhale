...
class MedicalGraph:
    def __init__(self):
        ...
        print('current foler: {}'.format(current_dir))
        self.data_path = os.path.join(current_dir, 'data/disease.csv')
        self.graph = Graph("http://localhost:7474", username="neo4j", password="1234")
